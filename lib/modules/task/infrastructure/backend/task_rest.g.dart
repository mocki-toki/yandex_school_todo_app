...
class _TaskRestClient implements TaskRestClient {
  ...
  @override
  Future<TaskListResponse> createTask(revision, request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'X-Last-Known-Revision': revision};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<TaskListResponse> editTask(revision, taskId, request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'X-Last-Known-Revision': revision};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<TaskListResponse> deleteTask(revision, taskId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'X-Last-Known-Revision': revision};
    _headers.removeWhere((k, v) => v == null);
